...
metadata:
  short-description: "Analyze phase dependencies and suggest Depends on entries for ROADMAP.md"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gsd-analyze-dependencies`.
- Treat all user text after `$gsd-analyze-dependencies` as `{{GSD_ARGS}}`.
...
<execution_context>
@C:/CurrIA/.codex/get-shit-done/workflows/analyze-dependencies.md
</execution_context>
...
<process>
Execute the analyze-dependencies workflow from @C:/CurrIA/.codex/get-shit-done/workflows/analyze-dependencies.md end-to-end.
