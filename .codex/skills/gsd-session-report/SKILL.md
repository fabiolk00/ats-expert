...
<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gsd-session-report`.
- Treat all user text after `$gsd-session-report` as `{{GSD_ARGS}}`.
...
<execution_context>
@C:/CurrIA/.codex/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @C:/CurrIA/.codex/get-shit-done/workflows/session-report.md end-to-end.
</process>
