...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/CurrIA/.codex
                  → checks C:/CurrIA/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/CurrIA/.codex/get-shit-done
                  → writes to C:/CurrIA/.codex/get-shit-done/hooks/
...
@C:/CurrIA/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/CurrIA/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/CurrIA/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/CurrIA/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/CurrIA/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
