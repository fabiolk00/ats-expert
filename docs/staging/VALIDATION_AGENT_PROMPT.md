...
Back to [Staging Documentation](./README.md) | [All Docs](../INDEX.md)
...
1. Read [docs/staging/VALIDATION_PLAN.md](./VALIDATION_PLAN.md) completely before running commands.
...
For each scenario in [docs/staging/VALIDATION_PLAN.md](./VALIDATION_PLAN.md):
