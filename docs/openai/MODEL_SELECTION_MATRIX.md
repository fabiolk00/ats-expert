---
title: OpenAI Model Selection Matrix
audience: [developers, architects]
related: [PORTUGUESE_QUALITY_GATE.md, PORTUGUESE_TEST_RESULTS.md, MIGRATION_CHECKLIST.md]
status: historical
updated: 2026-04-01
---
...
6. Record quality and cost in [portuguese-quality-test-results.md](./PORTUGUESE_TEST_RESULTS.md)
...
2. Transfer the scores into [portuguese-quality-test-results.md](./PORTUGUESE_TEST_RESULTS.md).
...
- [config.ts](../../src/lib/agent/config.ts)
- [README.md](../../README.md)
- [CLAUDE.md](../../CLAUDE.md)
