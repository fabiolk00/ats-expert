export const TOOL_ERROR_CODES = {
  ...
  GENERATE_FILE_SESSION_SOURCE_MISMATCH: 'GENERATE_FILE_SESSION_SOURCE_MISMATCH',
  GENERATE_FILE_LATEST_VERSION_MISSING: 'GENERATE_FILE_LATEST_VERSION_MISSING',
  GENERATE_RESUME_LATEST_VERSION_MISSING: 'GENERATE_RESUME_LATEST_VERSION_MISSING',
  GENERATE_RESUME_PENDING_GENERATION_MISSING: 'GENERATE_RESUME_PENDING_GENERATION_MISSING',
  GENERATE_RESUME_PENDING_GENERATION_REUSE_FAILED: 'GENERATE_RESUME_PENDING_GENERATION_REUSE_FAILED',
  GENERATE_RESUME_PENDING_GENERATION_CREATE_FAILED: 'GENERATE_RESUME_PENDING_GENERATION_CREATE_FAILED',
  GENERATE_RESUME_PENDING_GENERATION_CONSTRAINT_FAILED: 'GENERATE_RESUME_PENDING_GENERATION_CONSTRAINT_FAILED',
  GENERATE_RESUME_RESERVATION_FAILED: 'GENERATE_RESUME_RESERVATION_FAILED',
  GENERATE_RESUME_RENDER_FAILED: 'GENERATE_RESUME_RENDER_FAILED',
  GENERATE_RESUME_PERSISTENCE_FAILED: 'GENERATE_RESUME_PERSISTENCE_FAILED',
...
const HTTP_STATUS_TO_TOOL_ERROR_CODE: Readonly<Partial<Record<number, ToolErrorCode>>> = {
  ...
  409: TOOL_ERROR_CODES.PRECONDITION_FAILED,
...
const TOOL_ERROR_HTTP_STATUS: Readonly<Record<ToolErrorCode, number>> = {
  ...
  [TOOL_ERROR_CODES.PRECONDITION_FAILED]: 409,
  [TOOL_ERROR_CODES.GENERATE_FILE_SESSION_SOURCE_MISMATCH]: 409,
  [TOOL_ERROR_CODES.GENERATE_FILE_LATEST_VERSION_MISSING]: 409,
  [TOOL_ERROR_CODES.GENERATE_RESUME_LATEST_VERSION_MISSING]: 409,
  [TOOL_ERROR_CODES.GENERATE_RESUME_PENDING_GENERATION_MISSING]: 409,
  [TOOL_ERROR_CODES.GENERATE_RESUME_PENDING_GENERATION_REUSE_FAILED]: 500,
  [TOOL_ERROR_CODES.GENERATE_RESUME_PENDING_GENERATION_CREATE_FAILED]: 500,
  [TOOL_ERROR_CODES.GENERATE_RESUME_PENDING_GENERATION_CONSTRAINT_FAILED]: 500,
  [TOOL_ERROR_CODES.GENERATE_RESUME_RESERVATION_FAILED]: 500,
  [TOOL_ERROR_CODES.GENERATE_RESUME_RENDER_FAILED]: 500,
  [TOOL_ERROR_CODES.GENERATE_RESUME_PERSISTENCE_FAILED]: 500,
  ...
  [TOOL_ERROR_CODES.INSUFFICIENT_CREDITS]: 402,
