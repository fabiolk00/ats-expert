    ...
    try {
      ...
      nextHighlightState = {
        ...
        reviewItems: validation.issues.map((issue, index) => ({
          ...
          whyItMatters: 'Revise este ponto para manter o currículo fiel ao seu histórico real.',
          suggestedAction: 'Ajuste a redação para evitar afirmações sem evidência no currículo original.',
