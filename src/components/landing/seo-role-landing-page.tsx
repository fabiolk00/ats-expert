              ...
              {config.internalLinks.map((link, i) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-5">
                    <h3 className="mb-1 font-semibold leading-tight text-white">{link.label}</h3>
                    <p className="mb-3 text-xs text-white/70">{link.description}</p>
                    <span className="inline-flex items-center gap-1 text-xs font-semibold text-white">
                      Ver guia <ArrowRight className="h-3.5 w-3.5 transition-transform duration-300 group-hover:translate-x-1" />
                    </span>
                  </div>
                </Link>
              ))}
