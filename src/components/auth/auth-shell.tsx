...
export default function AuthShell({
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <section className="flex flex-1 items-center justify-center bg-muted/30 p-6 lg:w-1/2 lg:p-12">
        <div className="w-full max-w-md rounded-xl border border-border/50 bg-card shadow-xl">
          <div className="p-8">
