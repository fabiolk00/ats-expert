...
function StepIndicator({ step }: { step: "signup" | "verify" }) {
  return (
    <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
      <span className={step === "signup" ? "font-medium text-primary" : ""}>Cadastro</span>
      <span className="text-muted-foreground/40">{">"}</span>
      <span className={step === "verify" ? "font-medium text-primary" : ""}>Verificacao</span>
    </div>
  )
}
...
export default function SignupForm() {
  ...
  if (step === "verify") {
    ...
    return (
      <Card className="w-full max-w-[400px] border-border/60 bg-card/95 shadow-none">
    ...
    <Card className="w-full max-w-[400px] border-border/60 bg-card/95 shadow-none">
      <CardHeader className="space-y-3 pb-4 text-center">
        ...
        <div className="space-y-1 pt-1">
          ...
          <p className="text-sm font-medium text-primary">1 analise gratuita incluida</p>
          <p className="text-xs text-muted-foreground">Sem cartao de credito</p>
        </div>
      </CardHeader>
