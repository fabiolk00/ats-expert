...
import { engenheiroDadosConfig } from "@/lib/seo/role-landing-config"
import { getAppOrigin } from "@/lib/config/app-url"

const config = engenheiroDadosConfig
...
export default function CurriculoEngenheiroDadosAtsPage() {
